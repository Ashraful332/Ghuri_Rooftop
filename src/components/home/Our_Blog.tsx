...
const Our_Blog = () => {
    ...
    return (
        <div className="flex-center mt-low max-w-[1170px] h-auto mx-auto pt-4">
            <p className="text-[14px] ">Our Blog</p>
            <h3 className="text-heading mb-m">Recent Articles</h3>
            ...
            {blogs.map((blog) => (
                ...
                >
                    ...
                    <div className="w-auto md:w-[50%]">
                        <p>{blog.date}</p>
                        <h3 className=" font-bold text-lg md:text-2xl mt-2 mb-4">{blog.title}</h3>
