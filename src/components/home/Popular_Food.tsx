...
const Popular_Food = () => {
    ...
    return (
        <div className="flex-center max-w-[1170px] h-auto mx-auto pb-9 ">
            <h3 className=" text-heading mb-7 pt-16">Most popular food</h3>
            <p className=" w-[80vw] sm:w-[60%] lg:w-[35%] text-center mb-[50px] text-sm font-bold ">
                    ...
                    <div key={item.id} className="w-[97vw] sm:w-[370px] ">
                        ...
                        <div>
                            <div className="mt-5 flex justify-between text-2xl">
                                <h4 className="text-lg font-bold">{item.foodName}</h4>
                                <p>${item.price}</p>
                            </div>
                            <p className="text-c-sec text-sm pt-[6px] pb-12 ">
                                {item.details}
                            </p>
