    ...
    return (
        <div className="flex flex-col items-center gap-8">
            ...
            <form
                ...
                className="flex flex-col gap-6 w-[87%] md:w-auto max-w-[700px] mx-auto bg-white p-6 rounded-xl shadow-lg border border-gray-100"
            >
                {/* Name + Email */}
                <div className="flex flex-col sm:flex-row gap-4">
                    <input
                        ...
                        required
                        className="flex-1 border border-gray-300 rounded-lg py-2 px-4 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    />
                ...
                <textarea
                    ...
                    className="border border-gray-300 rounded-lg py-3 px-4 h-32 resize-none focus:ring-2 focus:ring-blue-500 focus:outline-none"
                    value={comment}
                    required
                ...
                <div className="flex flex-col">
                 ...
                 file:bg-[var(--pc)] file:text-white hover:file:bg-[var(--sc)]
                 cursor-pointer"
                    />
                </div>
                ...
                <button
                    type="submit"
                    className="w-full sm:w-auto bg-gradient-to-b from-[var(--pc)] to-[var(--pc2)] 
               text-white py-3 px-6 rounded-lg font-semibold 
               hover:from-[var(--pc)] hover:to-[var(--sc)] transition-all 
               shadow-md"
                >
                    Submit Comment
                </button>
            ...
            {blogData.comments?.map((cmt: any, index: number) => (
                <div
                    key={index}
                    className="w-[87%] sm:w-[80%] lg:w-[700px] flex flex-col md:flex-row gap-3 mt-6 bg-gray-100 md:bg-[#ffffff00] rounded-lg "
                >
                    ...
                    <div className="hidden md:flex w-auto md:W-14 ">
                        <img
                            src={cmt?.photo}
                            alt="user photo"
                            className="rounded-full w-12 h-12 object-cover"
                    ...
                    <div className="p-4 bg-gray-100 rounded-xl w-full">
                        <div className="flex justify-between items-center mb-2">
                            <p className="text-sm font-semibold hidden md:flex">{cmt?.name}</p>
                            <p className="text-xs font-bold text-black/70">{cmt?.date}</p>
                        </div>
                        <p className="text-black/80 italic">{cmt?.comment}</p>
                    </div>
                </div>
            ))}
        </div>
...
//                     type="submit"
//                     className="py-2 px-4 bg-gradient-to-r from-green-400 to-blue-500 text-white rounded-lg font-semibold hover:from-green-500 hover:to-blue-600 transition-all">
//                     comment
//                 </button>
//             </form>
//             {blogData.comments?.map((cmt: any, index: number) => (
...
//                             />
//                         </div>
//                         <div className="p-6 bg-[#ddd] rounded-xl w-full">
//                             <div className="flex justify-between items-center mb-2">
//                                 <p className="text-sm font-semibold  ">{cmt?.name}</p>
//                                 <p className="text-xs font-bold text-black/90">{cmt?.date}</p>
//                             </div>
//                             <div>
//                                 <p className="text-black/80 italic ">{cmt?.comment}</p>
//                             </div>
